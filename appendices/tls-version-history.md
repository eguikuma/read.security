...
# appendix：SSL から TLS 1.3 への道のり

## はじめに

[02-tls](../02-tls.md) では、TLS 1.3（RFC 8446）を題材に、暗号化技術の組み合わせが「なぜ安全か」を学びました
...
1. [年表](#年表)
2. [SSL 2.0（1995 年）](#ssl-201995-年)
3. [SSL 3.0（1996 年）](#ssl-301996-年)
4. [TLS 1.0（1999 年）](#tls-101999-年)
5. [TLS 1.1（2006 年）](#tls-112006-年)
6. [TLS 1.2（2008 年）](#tls-122008-年)
7. [TLS 1.3（2018 年）](#tls-132018-年)
8. [バージョンの廃止と移行](#バージョンの廃止と移行)
9. [用語集](#用語集)
10. [参考資料](#参考資料)
...
- [Logjam - Imperfect Forward Secrecy: How Diffie-Hellman Fails in Practice](https://weakdh.org/)
