...
# appendix：ゼロトラストアーキテクチャ

## はじめに

[04-authentication](../04-authentication.md) では、ゼロトラストを「何も信頼せず、常に検証する」と紹介しました

[05-access-control](../05-access-control.md) では、ABAC（属性ベースアクセス制御）がゼロトラストの実装に適していることを学びました
...
1. [境界型セキュリティの限界](#境界型セキュリティの限界)
2. [ゼロトラストの 3 つの原則](#ゼロトラストの-3-つの原則)
3. [ゼロトラストと認証](#ゼロトラストと認証)
4. [ゼロトラストとアクセス制御](#ゼロトラストとアクセス制御)
5. [ゼロトラストと暗号化](#ゼロトラストと暗号化)
6. [マイクロセグメンテーション](#マイクロセグメンテーション)
7. [このリポジトリとの対応関係](#このリポジトリとの対応関係)
8. [まとめ](#まとめ)
9. [用語集](#用語集)
10. [参考資料](#参考資料)
...
### 原則 1：常に検証する（Never Trust, Always Verify）
